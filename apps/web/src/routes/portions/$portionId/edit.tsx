    ...
    <main className="mx-auto w-full max-w-lg px-4 py-6">
      <Card>
        <CardHeader className="flex flex-row items-center gap-2 pb-4">
          ...
          <CardTitle className="text-xl font-semibold tracking-[-0.02em]">Update Portion</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          {(field) => (
            <>
              ...
              <FieldContent>
                <TypeSelector
                  value={field.state.value}
                  onValueChange={(value) => field.handleChange(value as PortionFormState["type"])}
                  types={portionTypes}
